...
var _MainComponent = __webpack_require__(41);
...
var _actionCreator = __webpack_require__(73);

var _actionCreator2 = _interopRequireDefault(_actionCreator);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_store2.default.dispatch((0, _actionCreator2.default)());
...
var _PlaceTempComponent = __webpack_require__(42);

var _PlaceTempComponent2 = _interopRequireDefault(_PlaceTempComponent);
...
var Main = function Main(_ref) {
    ...
    return _react2.default.createElement(
        ...
        data.map(function (cityData) {
            return _react2.default.createElement(_PlaceTempComponent2.default, { cityData: cityData });
        })
    );
};
...
var PlaceTemp = function (_Component) {
    _inherits(PlaceTemp, _Component);

    function PlaceTemp() {
        _classCallCheck(this, PlaceTemp);

        return _possibleConstructorReturn(this, (PlaceTemp.__proto__ || Object.getPrototypeOf(PlaceTemp)).apply(this, arguments));
    }

    _createClass(PlaceTemp, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "data-container cont-" + this.props.cityData.name },
                _react2.default.createElement(
                    ...
                    ", ",
                    this.props.cityData.sys.country
                ),
                _react2.default.createElement(
                    "div",
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        "Weather: ",
                        this.props.cityData.weather.main
                    ),
                    _react2.default.createElement(
                        "h5",
                        null,
                        this.props.cityData.weather.description
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "temp" },
                        _react2.default.createElement(
                            ...
                            null,
                            "Actual temp: ",
                            this.props.cityData.main.temp
                        ),
                        _react2.default.createElement(
                            "p",
                            null,
                            "Max: ",
                            this.props.cityData.main.temp_max
                        ),
                        _react2.default.createElement(
                            "p",
                            null,
                            "Min: ",
                            this.props.cityData.main.temp_min
                        )
                    )
                )
            );
...
var reducer = function reducer(state, action) {
  if (action.type === "SAVE_DATA") {
    return _extends({}, state, {
      historyData: _extends({}, state.historyData)
    });
...
exports.default = (0, _redux.createStore)(reducer, { tempData: [], historyData: {} }, (0, _redux.applyMiddleware)(_reduxThunk2.default, logger));
...
function apiCall(dispatch) {
    // Call to API
    fetch("http://api.openweathermap.org/data/2.5/group?id=3936456,3871336,7521912,6693229&units=metric&appid=4cdc12514e4533c3bd4727bce94ce099").then(function (response) {
...
var loadPlaceTemp = function loadPlaceTemp() {
